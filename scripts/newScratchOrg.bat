...
call sfdx force:package:install --package 04t2o000000yPxwAAE  -k navcrm --wait 10 --publishwait 10

:: Installer crm-platform-access-control
call sfdx force:package:install --package 04t2o000000yPvWAAU  -k navcrm --wait 10 --publishwait 10
