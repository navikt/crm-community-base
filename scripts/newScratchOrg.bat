...
call sfdx force:package:install --package 04t2o000000yQ4TAAU -r -k %3 --wait 10 --publishwait 10

:: Installer crm-platform-access-control
call sfdx force:package:install --package 04t2o000000yQ4dAAE -r -k %3 --wait 10 --publishwait 10
